...
python run_train.py --log.exp_dir $expm_folder --data.dataset cifar100 --data.way 2 --data.test_way 2 --model.drop 0.3 --data.batch_size 32 --model.groupnorm True --train.learning_rate 0.001 --train.lr_decay 0.99 --train.patience 500 --base_learner.method LRD2 --base_learner.iterations $1 --base_learner.init_lambda 1 --base_learner.linsys True --base_learner.init_adj_scale 1
